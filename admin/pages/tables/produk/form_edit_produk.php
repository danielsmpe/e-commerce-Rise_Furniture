                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../produk/table_produk.php">Data produk</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="../supplier/table_supplier.php">Data supplier</a>
                                        </li>
                                        <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="table_produk.php" class="breadcrumb-link">Data
                                                    produk</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form produk
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <form action="process/edit_produk.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="card">
                                    <h5 class="card-header">Cover produk</h5>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">ID produk</label>
                                            <div class="col-md-9">
                                                <input type="text" name="id_produk" class="form-control" value="<?php echo $id_produk ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Judul produk</label>
                                            <div class="col-md-9">
                                                <input type="text" name="judul_produk" class="form-control" placeholder="Judul produk"
                                                    value="<?php echo $item['judul_produk'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                {
                                                    if($item['id_supplier'] == $isi['id_supplier'])
                                                    {
                                                        $tag = 'selected';
                                                    }
                                                    else
                                                    ...
                                                    echo "<option value='".$isi['id_supplier']."'".$tag.">".$isi['nama_supplier']."</option>";
                                                }
                                                ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row mt-5">
                                            <div class="col-md-6">
                                                ...
                                                <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg"
                                                    href="table_produk.php" role="button">Kembali</a>
                                            </div>
