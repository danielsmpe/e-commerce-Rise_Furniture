                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="form_produk.php" class="btn btn-primary">Tambah Data</a>
                                <?php
                                $message = '';
                                if(isset($_GET["error"]))
                                {
                                ...
                                <table id="tabell" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "SELECT b.id_produk,b.judul_produk,pg.nama_supplier,b.stok,b.gambar,b.deleted from produk b,supplier pg WHERE b.id_supplier = pg.id_supplier 
                                            AND
                                            b.deleted = 0 ORDER BY b.id_produk";                                      
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='form_edit_produk.php?id_produk=$id_produk' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_produk.php?id_produk=$id_produk' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
