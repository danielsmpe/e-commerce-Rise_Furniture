                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="table_produk.php">Data produk</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/add_produk.php" method="POST" enctype="multipart/form-data">

                                    <?php 
                                    $tampilkan_isi = "select count(id_produk) as jumlah from produk;";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id_produk" class="form-control" value="BU-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select required name="id_supplier" class="form-control">
                                                ...
                                                while ($isi = mysqli_fetch_array($tampilkan_isi_sql))
                                                {
                                                    echo "<option value='".$isi['id_supplier']."'>".$isi['nama_supplier']."</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Cover produk</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="table_produk.php"
