    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../../../dashboard.php">Rise Store</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="../produk/table_produk.php">Data produk</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="table_supplier.php">Data supplier</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="table_supplier.php" class="breadcrumb-link">Data
                                                    supplier</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form supplier
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <form action="process/edit_supplier.php" method="POST">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">ID supplier</label>
                                        <div class="col-md-9">
                                            <input type="text" name="id_supplier" class="form-control" value="<?php echo $id_supplier ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nama_supplier" class="form-control" placeholder="Nama supplier"
                                                value="<?php echo $item['nama_supplier'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="alamat_supplier" id="" cols="30" rows="10" class="form-control"
                                                placeholder="Alamat supplier" required><?php echo $item['alamat_supplier'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" name="email_supplier" class="form-control" placeholder="Email supplier"
                                                value="<?php echo $item['email_supplier'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="telp_supplier" class="form-control" placeholder="Nomor Telepon"
                                                value="<?php echo $item['telp_supplier'] ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="table_supplier.php"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright 2021 - Designed by Kelompok 2 Kelas E. 
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
