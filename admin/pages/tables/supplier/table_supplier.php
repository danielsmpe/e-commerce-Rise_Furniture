                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="form_supplier.php" class="btn btn-primary">Tambah Data</a>
                                <?php
                                $message = '';
                                if(isset($_GET["error"]))
                                {
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='form_edit_supplier.php?id_supplier=$id_supplier' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_supplier.php?id_supplier=$id_supplier' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
