...
<head>
    ...
    <title>Admin | Rise Store<</title> </head> <body>
            <!-- ============================================================== -->
            <!-- main wrapper -->
            <!-- ============================================================== -->
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div id="submenu-5" class="collapse submenu" >
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/tables/produk/table_produk.php">Data
                                                        produk</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/tables/supplier/table_supplier.php">Data
                                                        supplier</a>
                                                </li>
                                                <li class="nav-item">
