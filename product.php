					...
					<div class="col-lg-6">
						<div class="details_content">
							...
							<div class="product_quantity_container">
								<div class="button cart_button"><a href="process/update-cart.php?id_produk=<?php echo $id_produk; ?>">Add to cart</a></div>
							</div>
							<?php } ?>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						...
						<div class="product_grid">
							<?php
								$query = 
								"SELECT * from produk WHERE id_kategori='$kategori' AND id_produk!='$id_produk'";
